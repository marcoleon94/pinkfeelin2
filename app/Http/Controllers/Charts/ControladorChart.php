...
class ControladorChart extends Controller
{
    public function index()
    {
      ...
      return view('chart')->with('clientes',$clientes)->with('nuevos', $nuevos)->with('ventames', $ventames)->with('masvendidos', $masvendidos)->with('envios', $envios)->with('pagos', $pagos)->with('tarjetas', $tarjetas);
    }
}
